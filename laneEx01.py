...
#    L = hls[:,:,1]
    ...
    #plt.figure(2)
    #plt.imshow(S)
    gradx1 = abs_sobel_thresh(S, orient='x', sobel_kernel=ksize, thresh=(50, 255.))
...
#    combined[((gradx1 == 1) & (grady1 == 1)) | ((mag_binary1 == 1))] = 1
    ...
    combined[((gradx1 == 1) & (grady1 == 1)) | ((mag_binary1 == 1)) |(thresholds == 1)] = 1
    color_select[combined] = [0.0,0.0,0.0]
...
#    kernel_size = 5
    low_threshold = 10
    high_threshold = 150
    masked_edges = cv2.Canny(color_select, low_threshold, high_threshold)
    return masked_edges
